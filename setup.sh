...
git clone https:/mirror.ghproxy.com/https://github.com/limonde/ChatGPT-Next-Web
cd ChatGPT-Next-Web
yarn install
...
OPENAI_API_KEY=$OPENAI_API_KEY  PORT=$PORT yarn build
OPENAI_API_KEY=$OPENAI_API_KEY  PORT=$PORT yarn start